...
class Balandis : Fragment() {
    var adapteris: Balandis.Adapteris? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val stringRequest = object : StringRequest(
            Request.Method.POST, EndPoints.URL_FECTH_JOBS ,
            ...
            override fun getParams():Map<String, String> {
                if((now.get(Calendar.MONTH)+1)==4){
                    ...
                    val data= LocalDate.parse("2019-04-01",formatter)
                    val dataaa=data.toString()
                    val param = HashMap<String, String>()
                    param.put("Userid",Userid)
                    param.put("Jobtype",Decision)
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            eilutes.imageView2.setOnClickListener {
                val dpd = DatePickerDialog(context, DatePickerDialog.OnDateSetListener{ view, year, month, dayOfMonth ->
                    ...
                    val dpd2 = DatePickerDialog(context, DatePickerDialog.OnDateSetListener { viewiki, yeariki, monthiki, dayOfMonth ->
                        metaiiki = year
                        meniki = month
                        dienaiki = dayOfMonth
